...
public class Caitlyn extends Character{
	public Caitlyn(int x, int y, String t,  ConsoleBox c) {
		super(1200, 700, 50, 50, 10, 1, x, y, t, "Caitlyn", c, new ImageIcon("literallyCaitlyn.png"), new ImageIcon("CaitlynIcon.png"));
